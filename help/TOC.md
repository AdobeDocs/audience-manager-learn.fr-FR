...
+ Implémentation web {#web-implementation}
   ...
   + SSF (transfert côté serveur) {#ssf}
      + [Utilisation des balises Experience Platform à implémenter dans les sites web](https://experienceleague.adobe.com/docs/launch-learn/implementing-in-websites-with-launch/index.html?lang=en)
